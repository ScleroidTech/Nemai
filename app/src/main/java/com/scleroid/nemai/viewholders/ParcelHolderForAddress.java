...
public class ParcelHolderForAddress extends HeaderItem {
     ...
     * @see Log
     */
    private static final String TAG = "ParcelHolderForAddress";
    ...
    public ParcelHolderForAddress(View itemView, RecyclerView.RecycledViewPool pool) {
        super(itemView);
        initHeader(itemView);
...
//        Log.d("whatNull, " , "rerefhefef" + innerRecyclerView.toString());
    ...
    private void setupInsideRecyclerView() {
        ...
        adapter = (AddressAdapter) innerRecyclerView.getAdapter();
    ...
    void clearContent() {
        // Glide.clear(mAvatar);
        ((AddressAdapter) innerRecyclerView.getAdapter()).clearData();
    }
